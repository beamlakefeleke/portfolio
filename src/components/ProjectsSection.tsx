...
const projects = [
  {
    ...
    outcome: '40% faster startup after lazy-loading refactor. Rolled out to 10k+ field agents.',
    tech: ['Flutter', 'BLoC', 'REST API', 'SQLite'],
    featured: true,
  },
  {
    id: 2,
    title: 'Chronos — Fintech Super-App',
    type: 'Mobile · Flutter',
    problem: 'Users needed a single app to manage banking, crypto, BNPL payments, and AI financial guidance — each backed by a separate service.',
    approach: 'Feature-first Flutter architecture with BLoC, GoRouter, and GetIt DI. Shared HTTP client with persistent bearer-token sessions connecting three backends: Chronos, BlockHub, and Panther AI. Wallet, cards, transfers, FX quotes, crypto, NFT portfolios, and TickPay BNPL built as independent feature modules. Multi-step onboarding, KYC, and biometric auth handled as dedicated workflows.',
    outcome: 'Full fintech super-app: banking + crypto + BNPL + AI insights in one modular codebase across 3 integrated backends.',
    tech: ['Flutter', 'BLoC', 'GoRouter', 'GetIt', 'REST APIs'],
    featured: true,
  },
  {
    id: 3,
